...
const ProfileCars = () => {
  return (
    <div className='flex flex-col space-y-3'>
      <ResultCarCard {...volkswagenCar2} pageDisplayed='profileCars' isFavorite={true}/>
      <ResultCarCard {...volkswagenCar3} pageDisplayed='profileCars' isFavorite={true}/>
      <ResultCarCard {...volkswagenCar4} pageDisplayed='profileCars' isFavorite={true}/>
    </div>
  )
}
