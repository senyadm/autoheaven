...
const VirtualizedList: React.FC<VirtualizedListProps> = React.memo(
  ({
    ...
    return (
      <div
        className={`relative w-full bg-white border border-gray-200 rounded shadow-md transition-transform transition-opacity duration-300 ease-in-out transform ${
