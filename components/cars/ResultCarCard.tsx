...
import { Calendar, Car, CheckCheck, ClipboardList, Divide, Flame, Fuel, Heart, Sliders, Wind } from 'lucide-react'
...
const DrivetrainIcon = (drivetrain) => {
  switch(drivetrain){
    case 'fwd':
      return <SvgIcon filepath='icons/cars/fwd.svg' alt='' width={16} height={16}/>
    default:
      return <SvgIcon filepath='icons/cars/fwd.svg' alt='' width={16} height={16}/>
  }  
}
const ResultCarCard = ({title,
  ...
  <div className='flex flex-col'>
    {
        isTop && <div className='flex h-6 w-full bg-orange-500 space-x-2 text-primary-foreground items-center'>
