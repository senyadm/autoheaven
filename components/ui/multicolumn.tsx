...
type MultiColumnSelectTriggerProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & {
    currentValue?: string;
    className?: string;
...
type MultiColumnSelectContentProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & {
    className?: string;
    children?: React.ReactNode;
    position?: string;
  };
...
type MultiColumnSelectItemProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & {
    className?: string;
    children?: React.ReactNode;
  };
...
type MultiColumnSelectSeparatorProps = React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item> & {
    className?: string;
    children?: React.ReactNode;
  };

const MultiColumnSelectSeparator = React.forwardRef<React.ElementRef<typeof SelectPrimitive.SelectSeparator>, MultiColumnSelectSeparatorProps>(
  ({ className, ...props }, ref) => (
