...
import { VehicleTypePage } from "../../../entities/vehicle";

const categories = [
  {
    icon: <CarIcon fill="#2463EB" />,
    href: `listheaven/${VehicleTypePage.Car}`,
    name: "Cars",
  },
  {
    icon: <MotoIcon />,
    href: `listheaven/${VehicleTypePage.Moto}`,
    name: "Moto",
  },
  {
    icon: <TruckIcon />,
    href: `listheaven/${VehicleTypePage.Truck}`,
    name: "Trucks",
  },
  {
    icon: <BusIcon />,
    href: `listheaven/${VehicleTypePage.Bus}`,
    name: "Buses",
  },
];
